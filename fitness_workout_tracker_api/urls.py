...
from fitness_workout_tracker_api.workouts.views import (
    WorkoutViewSet, 
    ExerciseViewSet, 
    WorkoutExerciseViewSet,
    WorkoutCommentViewSet
)
...
workouts_router.register(r'comments', WorkoutCommentViewSet, basename='workout-comments')
